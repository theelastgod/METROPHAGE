...
const JOBS = [
  ...
  // ── Interact NPC busts (regenerated) ─────────────────────────────────
  // interact_sheet.jpg is the only portrait sheet built as irregular bezel panels
  // (measured rows: 231/127/128/233px), so NO uniform frameWidth slices it — every
  // cell, and every single cropped from it, came out bezelled/off-centre and some
  // showed two characters. Regenerated as plain busts, matching the render site's
  // contract ('Singles are plain images (no frame)') and the other sheets.
  {
    id: "portrait_npc_porter",
    tag: "npcbusts",
    out: "portraits/interact/porter.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} CAPT. PORTER, a fixture of the METROPHAGE undercity: a weathered dock captain, deep brown skin, buzzed black hair, grey stubble, a heavy high-collared coat, cyan #29e7ff harbour light, level unimpressed gaze, a man who reads manifests for lies. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_tunnel_rat",
    tag: "npcbusts",
    out: "portraits/interact/tunnel_rat.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} TUNNEL RAT, a fixture of the METROPHAGE undercity: a slim wary man, very dark deep-umber skin, short black hair under a raised hood, a long dark coat, violet #b06bff tunnel glow, watchful and withdrawn, at home underground. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_scrap_boss",
    tag: "npcbusts",
    out: "portraits/interact/scrap_boss.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} SCRAP BOSS, a fixture of the METROPHAGE undercity: a heavy-set salvage boss, warm brown skin, short black hair, stubble, a battered coat over broad shoulders, amber #ffb13c yard light, appraising you like inventory. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_hawker",
    tag: "npcbusts",
    out: "portraits/interact/hawker.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} HAWKER, a fixture of the METROPHAGE undercity: a fast-talking street vendor, light tan skin, buzzed dark brown hair, mid-pitch with an eager grin, amber #ffb13c stall light, arms mid-gesture, selling you something barely legal. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_preacher",
    tag: "npcbusts",
    out: "portraits/interact/preacher.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} PREACHER, a fixture of the METROPHAGE undercity: a gaunt street prophet, very dark deep-umber skin, long silver-grey hair, full silver beard, a ragged cape, violet #b06bff glow, eyes lit with conviction, mid-sermon. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_street_kid",
    tag: "npcbusts",
    out: "portraits/interact/street_kid.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} STREET KID, a fixture of the METROPHAGE undercity: a scrawny teenager, medium tan skin, spiky rust-red hair, cocky challenging grin, acid-green #9dff3c neon, all restless energy, sizing you up. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_amb_tech",
    tag: "npcbusts",
    out: "portraits/interact/amb_tech.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} GRID TECH, a fixture of the METROPHAGE undercity: a grid technician, light tan skin, buzzed black hair under a flat cap, neat goatee, a utility coat, cyan #29e7ff panel glow, tired competent squint. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_amb_vendor",
    tag: "npcbusts",
    out: "portraits/interact/amb_vendor.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} NOODLE COOK, a fixture of the METROPHAGE undercity: a street noodle cook, warm brown skin, black hair in a bun, steam rising, orange #ff7a18 stall light, cheerful weathered face, mid-call to a customer. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_amb_courier",
    tag: "npcbusts",
    out: "portraits/interact/amb_courier.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} COURIER, a fixture of the METROPHAGE undercity: a lean courier, medium tan skin, rust-red ponytail, breathing hard as if just arrived, acid-green #9dff3c neon, impatient, already leaving. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_keep_den",
    tag: "npcbusts",
    out: "portraits/interact/keep_den.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} FENCE, a fixture of the METROPHAGE undercity: a hooded fence, warm brown skin, short black hair under a raised hood, a dark coat, magenta #ff2bd6 back-room glow, guarded sidelong look, says nothing twice. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_keep_citycenter",
    tag: "npcbusts",
    out: "portraits/interact/keep_citycenter.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
    prompt: `${STYLE_BUST} CIVIC AIDE, a fixture of the METROPHAGE undercity: a civic aide, warm brown skin, black hair in a neat bun, crisp official collar, cool blue #4d8cff lobby light, professional practiced smile that doesn't reach the eyes. Single character, shoulders-up, facing camera, plain dark background, no frame, no border, no UI panel, no text.`,
  },
  {
    id: "portrait_npc_subway_warden",
    tag: "npcbusts",
    out: "portraits/interact/subway_warden.jpg",
    kind: "portrait",
    maxSide: 256,
    quality: "medium",
    resolution: "1k",
