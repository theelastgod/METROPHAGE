...
const NPC_SERVICE_OVERRIDES: Record<string, NpcServiceId[]> = {
  ...
  // Regional — light
  porter: ["chat", "rumor"],
  tunnel_rat: ["chat", "cool_down"],
  arc_tech: ["chat", "cool_down"],
  scrap_boss: ["chat", "sell_core"],
  hawker: ["chat", "rumor"],
  preacher: ["chat", "bless"],
  street_kid: ["chat"],
  subway_warden: ["chat", "rumor"],
  ...
  amb_vendor: ["chat", "meal"],
  // Keepers — one job matching the room
  keep_bar: ["chat", "meal"],
  keep_shop: ["chat", "rumor"],
  keep_clinic: ["chat", "heal_charity", "heal_paid"],
  keep_guild: ["chat", "rumor"],
  ...
  res_echo: ["chat"],
  res_tallow: ["chat", "meal"],
  res_wren: ["chat", "cool_down"],
  res_pike: ["chat"],
