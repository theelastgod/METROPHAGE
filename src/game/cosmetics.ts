...
// are owned per identity (wallet account). GENESIS // KEY is granted iff the wallet
// holds any Genesis Key NFT — not a credit buy. Other nft-tier skins stay counsel-gated.
...
export const COSMETICS: Cosmetic[] = [
  ...
  { id: "genesis", name: "GENESIS // KEY", desc: "Granted by holding any Genesis Key — False Address deed", price: 0, nft: true, swatch: 0xff2bd6, look: { head: "crown", cloak: "cape", decal: "skull", color: 0xff2bd6, emblem: true, skin: 0xe6b58c, hair: "long", hairColor: 0x1b1820 }, provenance: "A False Address deed whose public chain outlived the registry that issued it.", streetRead: ["That founder mark survives in a ledger even Helios cannot quietly edit.", "On-chain permanence is not freedom, but it makes disappearance expensive for whoever wants your history gone.", "Quill found the issuing registry in an earlier cycle. Your proof survived its government, its corporation, and at least one version of this city."] },
];
