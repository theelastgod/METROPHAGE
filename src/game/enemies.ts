...
// NOTE: credit rewards are SERVER-authoritative (server/src/world.ts ENEMY_ARCHES).
// This file carries client-side flavor/visuals only — do not add economy numbers here.
...
export const ENEMY_TIERS: Record<string, EnemyTierDef> = {
  ...
  thug: {
    ...
    attack: "slam", attackDamage: 10, shotSpeed: 0, slamRadius: 40, slamWindupMs: 300, kite: false, xp: 7,
  },
  ...
  palantir: {
    ...
    attack: "shot", attackDamage: 20, shotSpeed: 480, slamRadius: 0, slamWindupMs: 0, kite: true, xp: 45, statusResist: 0.3,
  },
  ...
  ripperdog: {
    ...
    attack: "slam", attackDamage: 14, shotSpeed: 0, slamRadius: 38, slamWindupMs: 230, kite: false, xp: 14,
  },
  ...
  mutant: {
    ...
    attack: "slam", attackDamage: 30, shotSpeed: 0, slamRadius: 64, slamWindupMs: 650, kite: false, xp: 40, statusResist: 0.4,
  },
  ...
  ratswarm: {
    ...
    attack: "slam", attackDamage: 4, shotSpeed: 0, slamRadius: 30, slamWindupMs: 150, kite: false, xp: 5,
  },
  ...
  sentinel: {
    ...
    attack: "shot", attackDamage: 14, shotSpeed: 440, slamRadius: 0, slamWindupMs: 0, kite: true, xp: 24,
  },
};
