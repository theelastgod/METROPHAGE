...
export const TUTORIAL_CHAMBERS: TutorialChamber[] = [
  ...
  { id: "range", title: "◢ FIRING RANGE", subtitle: "aimed fire", x1: 9, x2: 12, y1: 5, y2: 25, floor: FLOOR.grate, accent: 0xff7a18, labelTile: [10, 7] },
  { id: "combat", title: "◢ COMBAT PIT", subtitle: "drop the patrol", x1: 14, x2: 17, y1: 5, y2: 25, floor: FLOOR.dirt, accent: 0xff3b6b, labelTile: [15, 7] },
...
export const TUTORIAL_INSTRUCTORS: TutorialInstructor[] = [
  ...
  },
  {
    ...
    lines: [
      "This is my lane. Hold the mouse where you want to shoot — click to fire.",
      "Every bolt is aimed intent. The server validates rate and hit.",
      "Land five shots on the wall targets, then head to the combat pit.",
    ],
  },
  {
    id: "six",
    ...
    lines: [
      ...
      "Drop the red hostile in this pit. Salvage spawns where it falls.",
      "Click to fire. Aim true.",
    ],
  },
  {
    id: "jyn",
...
/** Extra instructors for FULL training — seated in Systems Court. */
export const TUTORIAL_INSTRUCTORS_FULL: TutorialInstructor[] = [
  { id: "cell", name: "CELL LIAISON", tag: "FACTIONS", chamber: "systems", kind: "faction", tile: [32, 10], color: 0xff79c6, fullOnly: true, look: look({ color: 0xff79c6, head: "beret", sex: "f", skin: 0xe6b58c, hair: "short", hairColor: 0x1b1820, cloak: "coat" }), lines: ["Your signature colour chose your CELL — one of four factions.", "Capturing nodes scores your cell. Press SPACE when you've read this."] },
  { id: "forge", name: "FORGE TECH", tag: "FORGE", chamber: "systems", kind: "craft", tile: [34, 10], color: 0xff2bd6, fullOnly: true, look: look({ color: 0xff2bd6, sex: "f", gloves: "wraps", skin: 0xc98a5e, hair: "undercut", hairColor: 0x1b1820, cloak: "coat" }), lines: ["Press G — upgrade, reforge, fuse, or salvage. Free in the drill.", "The server validates every craft."] },
  { id: "qm", name: "QUARTERMASTER", tag: "VENDOR", chamber: "systems", kind: "vendor", tile: [32, 13], color: 0xf7ff3c, fullOnly: true, look: look({ color: 0xf7ff3c, head: "cap", strap: true, skin: 0xc98a5e, hair: "short", beard: "stubble", cloak: "coat" }), lines: ["Press B — the quartermaster sells heals and gear caches.", "Reputation tiers unlock better stock."] },
  { id: "fence", name: "THE FENCE", tag: "MARKET", chamber: "systems", kind: "market", tile: [34, 13], color: 0xff7a18, fullOnly: true, look: look({ color: 0xff7a18, head: "hood", cloak: "coat", skin: 0x7c4f30 }), lines: ["Press K — cross-zone auction house.", "List items, bid, cancel — escrow is server-side."] },
  { id: "fixer", name: "THE FIXER", tag: "CONTRACTS", chamber: "systems", kind: "contracts", tile: [32, 16], color: 0x39ff88, fullOnly: true, look: look({ color: 0x39ff88, head: "hood", skin: 0x4f3220, hair: "long", hairColor: 0xc7cdd8, cloak: "coat" }), lines: ["Press J — daily contracts: kills, bosses, collection runs.", "Credits, cores, and vendor rep on completion."] },
  { id: "tailor", name: "THE TAILOR", tag: "WARDROBE", chamber: "systems", kind: "cosmetics", tile: [34, 16], color: 0xff5fa2, fullOnly: true, look: look({ color: 0xff5fa2, head: "beret", skin: 0xf3d2b8, hair: "bun", hairColor: 0xff5fb0 }), lines: ["Press Y — transmog only, zero combat power.", "Your look still relays to every player."] },
  { id: "org", name: "ORGANIZER", tag: "CELL GUILD", chamber: "systems", kind: "guild", tile: [32, 19], color: 0x4d8cff, fullOnly: true, look: look({ color: 0x4d8cff, head: "cap", skin: 0xf3d2b8, hair: "short", hairColor: 0x4a2f1c, cloak: "coat" }), lines: ["Press C — your persistent guild: shared bank, roster, ranks.", "Invite free minds and pool resources."] },
  { id: "arch", name: "ARCHIVIST", tag: "BOARD", chamber: "systems", kind: "board", tile: [34, 19], color: 0x00e5ff, fullOnly: true, look: look({ color: 0x00e5ff, head: "beret", skin: 0xa9794a, hair: "bun", hairColor: 0x1b1820 }), lines: ["Press L — achievements and cross-zone leaderboards.", "Milestones pay out automatically."] },
  { id: "nav", name: "NAVIGATOR", tag: "MAP", chamber: "systems", kind: "map", tile: [32, 22], color: 0x2cf5c8, fullOnly: true, look: look({ color: 0x2cf5c8, head: "cap", skin: 0xa9794a, hair: "dreads" }), lines: ["Press M — discovered zones and fast travel.", "Black tiles are unknown until you arrive."] },
  { id: "mime", name: "SIGNALLER", tag: "EMOTES", chamber: "systems", kind: "emote", tile: [34, 22], color: 0xc04bff, fullOnly: true, look: look({ color: 0xc04bff, head: "cap", skin: 0x7c4f30, hair: "spiky", hairColor: 0x1b1820, cloak: "coat" }), lines: ["Press V — emote wheel: gestures above your avatar or world pings.", "Coordination without chat spam."] },
  { id: "arc", name: "STORY ARCHIVIST", tag: "CAMPAIGN", chamber: "systems", kind: "campaign", tile: [31, 11], color: 0xeafdff, fullOnly: true, look: look({ color: 0xeafdff, cloak: "cape", skin: 0x4f3220, hair: "long", beard: "full", hairColor: 0xc7cdd8 }), lines: ["Your personal campaign runs parallel to everyone else's.", "THE FIXER posts beats — persisted to your account. SPACE to continue."] },
  { id: "arena", name: "ARENA MARSHAL", tag: "PVP", chamber: "systems", kind: "pvp", tile: [35, 11], color: 0xff3b6b, fullOnly: true, look: look({ color: 0xff3b6b, build: "normal", head: "cap", skin: 0xc98a5e, hair: "short", hairColor: 0x1b1820, beard: "stubble", cloak: "coat" }), lines: ["PvP only in THE CRUCIBLE — southeast arena, away from story.", "Chat and emotes work everywhere. SPACE to continue."] },
  { id: "trade", name: "ESCROW AGENT", tag: "TRADE", chamber: "systems", kind: "trade", tile: [35, 22], color: 0x9dff3c, fullOnly: true, look: look({ color: 0x9dff3c, gloves: "wraps", strap: true, skin: 0x7c4f30 }), lines: ["/trade <name> · /offer · /confirm on both sides. /tcancel to abort.", "Face-to-face secure trades. SPACE to continue."] },
  { id: "port", name: "GATE OFFICER", tag: "TRAVEL", chamber: "systems", kind: "travel", tile: [33, 22], color: 0x8fe9ff, fullOnly: true, look: look({ color: 0x8fe9ff, head: "cap", cloak: "coat", legGear: "greaves", skin: 0xe6b58c, hair: "buzz", hairColor: 0x1b1820 }), lines: ["H recalls you to the safehouse. M fast-travels to discovered zones.", "Doors and the subway are separate combat spaces. SPACE to continue."] },
];
...
export function chamberForKind(kind: TutorialKind): TutorialChamber | undefined {
  ...
  if (!inst) return kind === "portal" ? TUTORIAL_CHAMBERS.find((c) => c.id === "deploy") : undefined;
