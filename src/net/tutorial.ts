...
const METRO_BRIDGE: TutorialStepDef = {
  ...
  title: "$METRO BRIDGE",
  teach:
    "The ◈ $METRO bridge is a player-funded cash-out rail on Robinhood Chain. Deposits add to the pool; withdrawals only pay while the pool can cover them — otherwise: Check back later.",
