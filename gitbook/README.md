---
description: The field manual for a neon-noir cyberpunk action-MMO in the browser.
---

# METROPHAGE

![METROPHAGE](.gitbook/assets/cover.svg)
...
* **Economy** — off-chain `credits` (₵) bridged to a tradeable **$METRO** (◈) SPL token on Solana
